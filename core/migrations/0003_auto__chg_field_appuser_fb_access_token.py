...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AppUser.fb_access_token'
        db.alter_column(u'core_appuser', 'fb_access_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AppUser.fb_access_token'
        raise RuntimeError("Cannot reverse this migration. 'AppUser.fb_access_token' and its values cannot be restored.")

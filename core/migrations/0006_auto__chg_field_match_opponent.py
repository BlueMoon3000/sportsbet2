...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Match.opponent'
        db.alter_column(u'core_match', 'opponent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.AppUser']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Match.opponent'
        raise RuntimeError("Cannot reverse this migration. 'Match.opponent' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_match', (
            ...
            ('code', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='match_set_player', to=orm['core.AppUser'])),
            ('opponent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='match_set_opponent', to=orm['core.AppUser'])),
        ))
        db.send_create_signal(u'core', ['Match'])

        # Adding model 'Pick'
        db.create_table(u'core_pick', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('match', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Match'])),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AppUser'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Team'])),
        ))
        db.send_create_signal(u'core', ['Pick'])
    ...
    models = {
        ...
        u'core.match': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'opponent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'match_set_opponent'", 'to': u"orm['core.AppUser']"}),
